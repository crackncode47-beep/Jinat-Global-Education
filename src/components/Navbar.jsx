...
export default function Navbar() {
  ...
  const navLabels = lang === 'en'
    ? { home: 'Home', about: 'About Us', campuses: 'Campuses', programs: 'Academic Programs', it: 'IT & Innovation', contact: 'Contact Us' }
    : { home: 'হোম', about: 'আমাদের সম্পর্কে', campuses: 'ক্যাম্পাস', programs: 'একাডেমিক প্রোগ্রাম', it: 'আইটি ও উদ্ভাবন', contact: 'যোগাযোগ' }
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {menuOpen && (
          <div className="lg:hidden border-t border-gray-100 py-4 space-y-1">
            {[['/','home'],['/about','about'],['/programs','programs'],['/it-innovation','it'],['/contact','contact']].map(([path, key]) => (
